...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoid2lsbGllZWciLCJhIjoiY2s3M3RrZm9lMDA0YzNycGNjbWc5ZnU4diJ9.FUtgTV2Aom_kraOwzk7JgQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/willieeg/ck73vnoan1xf71io7knqi61wc',
...
// xport const updateData = async (name, email) => {
...
var stripe = Stripe('pk_test_lNFUvfSdl08p9Am7k6QjbQG500P84YN0CU');
